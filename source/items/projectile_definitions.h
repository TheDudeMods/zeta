...
struct s_projectile_definition : s_object_definition
{
	...
	real_fraction ai_target_leading_scale;
	real_fraction targeted_leading_fraction;
	real guided_error_radius;
	c_tag_block<s_projectile_material_response_old> material_responses_old;
	c_tag_block<s_projectile_material_response> material_responses;
	c_tag_block<s_projectile_brute_grenade> brute_grenade;
	c_tag_block<s_projectile_fire_bomb_grenade> fire_bomb_grenade;
	c_tag_block<s_projectile_conical_spread> conical_spread;
