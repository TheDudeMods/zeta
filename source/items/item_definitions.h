...
struct s_item_definition : s_object_definition
{
	...
	c_tag_block<s_item_predicted_bitmap> predicted_bitmaps;
	...
	real campaign_ground_scale;
	real multiplayer_ground_scale;
	real small_hold_scale;
	real small_holster_scale;
	real medium_hold_scale;
	real medium_holster_scale;
	real large_hold_scale;
	real large_holster_scale;
	real huge_hold_scale;
	real huge_holster_scale;
	real grounded_friction_length;
	real grounded_friction_unknown;
};
static_assert(sizeof(s_item_definition) == sizeof(s_object_definition) + 0xB8);
