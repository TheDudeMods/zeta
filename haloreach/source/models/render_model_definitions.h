...
{
	string_id name;
	c_tag_block<s_render_model_permutation> permutations;
};
...
{
	string_id name;
	c_tag_block<s_render_model_marker> markers;
};
...
struct s_render_model_definition
{
	...
	c_tag_block<s_instance_node_map_mapping> node_map_mapping;
	c_tag_block<s_render_model_unknown1> unknown1;
	real unknowns[74];
	c_tag_block<s_render_model_unknown2> unknown2;
	c_tag_block<s_default_node_orientation> runtime_node_orientations;
};
