...
struct s_scenario
{
	...
	s_tag_block particle_emitters;
	s_tag_block unknown50;
	s_tag_block cinematics;
	s_tag_block cinematic_lights;
	s_tag_block unknown51;
	s_tag_block scenario_metagame;
